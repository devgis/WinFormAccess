...
namespace CAEELEDPlayer.Common
{
    ...
    {
        //数据库连接字符串
        public static readonly string conn = ConfigReader.DBConnectionString;
        ...
        public static OleDbDataReader ExecuteReader(string connectionString, string cmdText,
                                                    params OleDbParameter[] commandParameters)
        {
            //创建一个SqlCommand对象
            OleDbCommand cmd = new OleDbCommand();
        ...
        /// <returns></returns>
        public static DataSet Query(string p, OleDbParameter[] parameters)
        {
            return ExecuteDataSet(conn, p, parameters);
        }
        /// <summary>
        /// 是否存在
        /// </summary>
        ...
        /// <returns></returns>
        public static bool Exists(string p, OleDbParameter[] parameters)
        {
            return Convert.ToInt32(ExecuteScalar(conn, p, parameters)) > 0;
        }
        /// <summary>
        /// 是否执行成功
        /// </summary>
        ...
        /// <param name="parameters"></param>
        /// <returns></returns>
        public static int ExecuteSql(string p, OleDbParameter[] parameters)
        {
            return ExecuteNonQuery(conn, p, parameters);
        }
        /// <summary>
        /// 查询，无参数
        /// </summary>
        ...
        {
            return ExecuteDataSet(conn, p, new OleDbParameter[] {});
        }
    }
}